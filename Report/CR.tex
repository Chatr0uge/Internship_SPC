...
\begin{multicols}{2}
    ...
    \begin{figure}[H]
        \centering
        \hspace*{-1.45cm}\includegraphics[width=1.2\linewidth]{./figures/1d.pdf}
...
\begin{multicols}{2}
    ...
    \begin{figure}[H]
        \centering
        \hspace*{-1.3cm}\includegraphics[width = 1.1\linewidth]{./figures/Mean_delay.pdf}
        \label{}
    ...
    \begin{figure}[H]
        \centering
        \hspace*{0cm}\includegraphics[width = 1.1\linewidth]{./figures/Std_delay.pdf}
        \label{}
        \caption{Here we plots the linear and the 1d, 2d model prediction for $\tau_0$ over the $\langle \tau \rangle$.}
    \end{figure}
