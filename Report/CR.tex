...
\begin{multicols*}{2}
    ...
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    This makes a combination of 216 points in a 4D space, which is a reasonable number of points to train a machine learning model.
    However lets note that this multidimensional output space, brings some subtitlities to the problem. First what's the best pulse metrics to use for the training as input data.
\end{multicols*}
